...
This guide provides comprehensive documentation for the **react-native-native-modules** skill in the custom-plugin-react-native plugin.
...
```bash
# Invoke the skill
claude "react-native-native-modules - [your task description]"

# Example
claude "react-native-native-modules - analyze the current implementation"
```
...
def implement_react_native_native_modules(input_data):
    """
    Implement react-native-native-modules functionality.
