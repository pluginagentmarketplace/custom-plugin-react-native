# React Native Basics Guide

## Overview

This guide provides comprehensive documentation for the **react-native-basics** skill in the custom-plugin-react-native plugin.
...
```bash
# Invoke the skill
claude "react-native-basics - [your task description]"

# Example
claude "react-native-basics - analyze the current implementation"
```
...
def implement_react_native_basics(input_data):
    """
    Implement react-native-basics functionality.
