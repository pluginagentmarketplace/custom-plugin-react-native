...
This guide provides comprehensive documentation for the **react-native-testing** skill in the custom-plugin-react-native plugin.
...
```bash
# Invoke the skill
claude "react-native-testing - [your task description]"

# Example
claude "react-native-testing - analyze the current implementation"
```
...
def implement_react_native_testing(input_data):
    """
    Implement react-native-testing functionality.
