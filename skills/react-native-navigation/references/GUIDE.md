...
This guide provides comprehensive documentation for the **react-native-navigation** skill in the custom-plugin-react-native plugin.
...
```bash
# Invoke the skill
claude "react-native-navigation - [your task description]"

# Example
claude "react-native-navigation - analyze the current implementation"
```
...
def implement_react_native_navigation(input_data):
    """
    Implement react-native-navigation functionality.
